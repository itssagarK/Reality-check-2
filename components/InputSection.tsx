...
const InputSection: React.FC<InputSectionProps> = ({ 
  ...
  if (isCollapsed && isSidebar) {
    return (
      <motion.div 
        ...
        className="h-full w-full flex flex-col items-center py-8 cursor-pointer hover:bg-slate-100 transition-colors group border-r border-slate-200 bg-slate-50 relative overflow-hidden"
  ...
  return (
    <form onSubmit={onSubmit} className={`flex flex-col h-screen w-full bg-slate-50 relative overflow-hidden`}>
       ...
       {!isSidebar && (
        ...
        >
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-4 text-slate-900 tracking-tighter uppercase">
              Audit your <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-indigo-600">ambition.</span>
            </h2>
            <p className="text-slate-700 text-lg md:text-xl font-mono max-w-2xl mx-auto leading-relaxed">
              High-fidelity feasibility analysis powered by neural constraints.<br/>
              <span className="text-slate-500 text-sm mt-3 block uppercase tracking-[0.3em] font-bold">No motivation. Just cold, hard data.</span>
            </p>
        </motion.div>
      )}
      ...
      `}>
          ...
          <div className="shrink-0 h-14 flex items-center justify-between px-6 border-b border-white/40 bg-white/30 backdrop-blur-md">
              ...
              {isSidebar && onToggleCollapse && (
                  <button type="button" onClick={onToggleCollapse} className="text-slate-600 hover:text-slate-900 transition-colors p-1 hover:bg-slate-200 rounded-lg">
          ...
          <div className="flex-1 relative bg-white/20 min-h-0 group"> 
              <textarea
                  ...
                  className={`
                      ...
                      font-mono text-lg md:text-xl leading-relaxed text-slate-900 placeholder:text-slate-500
              ...
              />
              {/* Corner Accents */}
              <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-slate-300"></div>
              <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-slate-300"></div>
              <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-slate-300"></div>
              <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-slate-300"></div>
          </div>
                      ...
                      <>
                        ...
                        >
                            ...
                            <input 
                                ...
                                placeholder="UNSET"
                                className="bg-transparent text-sm text-slate-900 focus:outline-none font-mono placeholder:text-slate-500 w-full font-bold tracking-wider"
                            />
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                              <input 
                                  ...
                                  className="bg-transparent text-sm text-slate-900 focus:outline-none font-mono placeholder:text-slate-500 w-full font-bold tracking-wider"
                              />
                              <span className="text-[10px] font-mono text-slate-500 font-bold uppercase">hrs/d</span>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <select 
                                ...
                                className="bg-transparent text-sm text-slate-900 focus:outline-none font-mono appearance-none cursor-pointer w-full font-bold tracking-wider"
                            >
                                <option value="Beginner" className="bg-white">Level: 01 (Beginner)</option>
                                <option value="Intermediate" className="bg-white">Level: 02 (Intermediate)</option>
                                <option value="Expert" className="bg-white">Level: 03 (Expert)</option>
                            </select>
                        </motion.div>
                      </>
                    )}
